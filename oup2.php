  ...
  <body>
    ...
    <div class="container">
      ...
      <?php include("mobile-navbar2.php"); ?>
        ...
        <h3 class="text-center"><span class="label label-warning">Balance Update</span></h3><br>

      <div class="row">
        <div class="col-sm-10">
          <form class="form-inline" role="form" action="oup2.php" method="GET">
            ...
            <div class="form-group">
              <label class="sr-only" for="exampleInputPassword2">Balance</label>
              <input type="text" name="balance" class="form-control"placeholder="Remaining Balance">
            </div>
      ...
      <?php
     if ($_GET['balance'] || $_GET['id'])
        {
            $query = sprintf("UPDATE sales_order SET BALANCE='%s' WHERE id = '%s'",
                            $_GET['balance'],
                             $_GET['id']);
        }
    ...
    if ($result != null)
    {
      printf("Remaining balance of Order # %s successfully updated.", $_GET['id']);
    }
